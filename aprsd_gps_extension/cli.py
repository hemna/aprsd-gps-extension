#!/usr/bin/env python3
"""
CLI tool for aprsd-gps-extension configuration export.
"""
...
def export_config_cmd(format="json"):
    """Export extension configuration options."""
    try:
        from aprsd_gps_extension.conf.opts import export_config
...
def main():
    ...
    parser = argparse.ArgumentParser(
        description="Export aprsd-gps-extension configuration options"
    )
    parser.add_argument(
        "--format",
        choices=["dict", "json"],
